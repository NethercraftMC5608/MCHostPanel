...
define('KT_JAR_START','/usr/bin/java -Xmx%sM -jar craftbukkit.jar nogui');
define('KT_NGROK_START','/usr/bin/ngrok tcp -config ngrok.yml %s');
// Screen commands (these should never be modified)
define('KT_SCREEN_CMD_START','/usr/bin/screen -dmS %s /bin/bash');
